...
if (!function_exists('favicons'))
{
	function favicons($icons = NULL)
	{
		if ($icons == NULL)
		{
			...
			return '<link rel="icon" href="'.base_url('assets/img/icons/as.png').'" type="image/png"'.'><!-- default favicon -->'."\n\t".
			'<link rel="shortcut icon" href="'.base_url('as.png').'"><!-- legacy default favicon (in root, 32x32) -->'."\n\t".
			'<link rel="apple-touch-icon" sizes="57x57" href="'.base_url('assets/img/icons/as.png').'"><!-- iPhone low-res and Android -->'."\n\t".
			'<link rel="apple-touch-icon-precomposed" sizes="57x57" href="'.base_url('assets/img/icons/as.png').'"><!-- legacy Android -->'."\n\t".
			'<link rel="apple-touch-icon" sizes="72x72" href="'.base_url('assets/img/icons/as.png').'"><!-- iPad -->'."\n\t".
			'<link rel="apple-touch-icon" sizes="114x114" href="'.base_url('assets/img/icons/as.png').'"><!-- iPhone 4 -->'."\n\t".
			'<link rel="apple-touch-icon" sizes="144x144" href="'.base_url('assets/img/icons/as.png').'"><!-- iPad hi-res -->'."\n";
		}
